...
{ 
  string protocol;
  CommandLine cmd;
  cmd.AddValue ("protocol", "Protocol Name", protocol);
  cmd.Parse (argc, argv);
  
  protocol = "ns3::Tcp"+protocol;
  // cout <<"Protocol is: "<<protocol<<"\n";
  ...
  app->Setup (ns3TcpSocket, sinkAddress, 3000, 50000, DataRate ("1Mbps"));
  nodes.Get (0)->AddApplication (app);
  app->SetStartTime (Seconds (1.));
  app->SetStopTime (Seconds (30.));

  AsciiTraceHelper asciiTraceHelper;
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("first.cwnd");
